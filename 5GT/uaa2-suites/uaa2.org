...
- Comment calcule-t-on $u_{n}$ à partir de $n$? Donne une formule en t'aidant
...
|---------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------|
| $u_0>0$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ |
|---------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------|
| $u_0<0$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ | $\lim\limits_{n\to\infty}u_n\ldots\ldots$ |
|---------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------+--------------------------------------------|
